...
export const CreateAccountSchema = z.object({
    ...
    .refine(data => data.personId || (data.firstName && data.lastName && data.personTypeId), { message: "Fournir soit un personId existant, soit les informations de la personne" });
